/**
 * \file    Milhoja_OmpTargetStreamManager.h
 *
 * \brief  Write this
 *
...
#ifndef MILHOJA_OMPTARGET_STREAM_MANAGER_H__
#define MILHOJA_OMPTARGET_STREAM_MANAGER_H__
...
class OmpTargetStreamManager {
public:
    ~OmpTargetStreamManager();

    static void                 initialize(const int nMaxStreams);
    static OmpTargetStreamManager&   instance(void);
    void                        finalize(void);
