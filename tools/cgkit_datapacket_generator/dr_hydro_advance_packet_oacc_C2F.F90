...
C_flZ_d) bind(c)
	...
	type(C_PTR), intent(IN), value :: C_loAuxC_d
	type(C_PTR), intent(IN), value :: C_loU_d
	type(C_PTR), intent(IN), value :: C_loFl_d
	...
	integer, pointer :: F_loAuxC_d(:,:)
	integer, pointer :: F_loU_d(:,:)
	integer, pointer :: F_loFl_d(:,:)
	real, pointer :: F_U_d(:,:,:,:,:)
	...
	CALL C_F_POINTER(C_loAuxC_d, F_loAuxC_d, shape=[3, F_nTiles_h])
	CALL C_F_POINTER(C_loU_d, F_loU_d, shape=[4, F_nTiles_h])
	CALL C_F_POINTER(C_loFl_d, F_loFl_d, shape=[4, F_nTiles_h])
