    ...
    def generate_source_code(self, destination, overwrite):
        ...
        with open(source_filename, "w") as fptr:
            ...
            for arg in sorted(list(scratch_vars)):
                ...
                fptr.write("\n")
                fptr.write(f"#ifdef DEBUG_RUNTIME\n{INDENT}{{\n")
                fptr.write(f'{INDENT*2}std::string   msg = "[{classname}::acquireScratch] Acquired"\n')
                fptr.write(f"{INDENT*6}+ std::to_string(nThreads)\n")
                fptr.write(f'{INDENT*6}+ " {arg}_ scratch blocks";\n')
                fptr.write(f"{INDENT*2}milhoja::Logger::instance().log(msg);\n")
                fptr.write(f"{INDENT}}}\n#endif\n")
            fptr.write("}\n")
            fptr.write("\n")
            ...
            for arg in sorted(list(scratch_vars)):
                ...
                fptr.write("\n")
                fptr.write(f"#ifdef DEBUG_RUNTIME\n{INDENT}{{\n")
                fptr.write(f'{INDENT*2}std::string   msg = "[{classname}::releaseScratch] ')
            ...
            fptr.write("{\n")
            fptr.write(f"#ifdef DEBUG_RUNTIME\n{INDENT}{{\n")
            fptr.write(f'{INDENT*2}std::string   msg = "[{classname}] ')
