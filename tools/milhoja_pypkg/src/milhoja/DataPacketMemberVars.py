class DataPacketMemberVars:
    """
    This class stores information from items in the data
    packet for keeping data mapping consistent.

    TODO: There should be some way to adjust the formatting
    of variable names for function scoped variables.
    """
    ...
    def size(self):
        """
        Returns the size **variable** for *item*.
        This is not the size equation.

        :param bool use_total_size: Returns the size variable
                                    times nTiles instead of just
                                    the size variable.
        """
