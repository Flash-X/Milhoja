...
class TestSubroutineGroup_BadSubroutines(unittest.TestCase):
    def setUp(self):
        ...
        # Reference must be full group specification and ideally
    ...
    def testBadSource(self):
        ...
        bad_sub_spec = bad_spec[self.__name]
    ...
    def testArgumentList(self):
        good_sub_spec = self.__good[self.__name]
