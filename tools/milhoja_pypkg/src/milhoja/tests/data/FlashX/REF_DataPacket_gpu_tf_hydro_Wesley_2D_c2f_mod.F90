module DataPacket_gpu_tf_hydro_c2f_mod
    ...
    interface
        function instantiate_gpu_tf_hydro_packet_c( &
            ...
            C_packet &
                ...
                bind(c, name="instantiate_gpu_tf_hydro_packet_c")
        ...
        function delete_gpu_tf_hydro_packet_c(C_packet) result(C_ierr) &
                bind(c, name="delete_gpu_tf_hydro_packet_c")
            use iso_c_binding, ONLY : C_PTR
    ...
    interface
        function release_gpu_tf_hydro_extra_queue_c(C_packet, C_id) result(C_ierr) &
                bind(c, name="release_gpu_tf_hydro_extra_queue_c")
            use iso_c_binding, ONLY : C_PTR
            use milhoja_types_mod, ONLY : MILHOJA_INT
            type(C_PTR), intent(IN), value :: C_packet
