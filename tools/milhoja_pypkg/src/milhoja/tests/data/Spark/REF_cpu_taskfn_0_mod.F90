...
contains
   ...
   subroutine cpu_taskfn_0_Fortran( &
      ...
      real, intent(INOUT) :: scratch_Hydro_hy_grav(:, :, :, :)
      real, intent(INOUT) :: scratch_Hydro_hy_rope(:, :, :, :)
      real, intent(INOUT) :: scratch_Hydro_hy_starState(:, :, :, :)
      real, intent(INOUT) :: scratch_Hydro_hy_tmpState(:, :, :, :)
      real, intent(INOUT) :: scratch_Hydro_hy_uMinus(:, :, :, :)
      real, intent(INOUT) :: scratch_Hydro_hy_uPlus(:, :, :, :)
      real, intent(INOUT) :: scratch_Hydro_xCenter_fake(:)
      real, intent(INOUT) :: scratch_Hydro_xLeft_fake(:)
      real, intent(INOUT) :: scratch_Hydro_xRight_fake(:)
      real, intent(INOUT) :: scratch_Hydro_yCenter_fake(:)
