...
void DataPacket_gpu_tf_hydro::pack(void) {
    ...
    for (auto n = 0; n < _nTiles_h; n++) {
        ...
        constexpr std::size_t offset_U = (8 + 2 * 1 * MILHOJA_K1D) * (8 + 2 * 1 * MILHOJA_K2D) * (8 + 2 * 1 * MILHOJA_K3D) * static_cast<std::size_t>(0);
        constexpr std::size_t nBytes_U = (8 + 2 * 1 * MILHOJA_K1D) * (8 + 2 * 1 * MILHOJA_K2D) * (8 + 2 * 1 * MILHOJA_K3D) * ( 9 - 0 + 1 ) * sizeof(real);
...
void DataPacket_gpu_tf_hydro::unpack(void) {
    ...
    for (auto n = 0; n < _nTiles_h; ++n) {
        ...
        constexpr std::size_t nBytes_U = (8 + 2 * 1 * MILHOJA_K1D) * (8 + 2 * 1 * MILHOJA_K2D) * (8 + 2 * 1 * MILHOJA_K3D) * ( 8 - 0 + 1 ) * sizeof(real);
