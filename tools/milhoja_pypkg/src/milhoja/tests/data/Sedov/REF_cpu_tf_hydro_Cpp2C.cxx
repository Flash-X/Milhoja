...
extern "C" {
    ...
    void  cpu_tf_hydro_cpp2c (
        ...
        milhoja::Real tile_deltas_array[] = {tile_deltas.I(),tile_deltas.J(),tile_deltas.K()};
        int tile_interior[] = {tile_lo.I(),tile_hi.I(),tile_lo.J(),tile_hi.J(),tile_lo.K(),tile_hi.K()};
        int lbdd_CC_1[] = {tile_lbound.I(),tile_lbound.J(),tile_lbound.K(),1};
        int lbdd_scratch_hydro_op1_auxC[] = {tile_lo.I()-1,tile_lo.J()- 1,tile_lo.K()- 1};
        int lbdd_scratch_hydro_op1_flX[] = {tile_lo.I(),tile_lo.J(),tile_lo.K(),1};
