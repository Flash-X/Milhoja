...
module gpu_tf_test_mod
    ...
    interface
        ...
        function instantiate_gpu_tf_test_packet_C( &
                    C_packet, &
                    C_dt &
        ...
        end function instantiate_gpu_tf_test_packet_C
        ...
        !               data packet
        function delete_gpu_tf_test_packet_C(C_packet) result(C_ierr) bind(c)
            use iso_c_binding,     ONLY : C_PTR
            use milhoja_types_mod, ONLY : MILHOJA_INT
            type(C_PTR),         intent(IN), value :: C_packet
            integer(MILHOJA_INT)                   :: C_ierr
        end function delete_gpu_tf_test_packet_C
    end interface

    ! Milhoja-internal functions.  Milhoja users should not call these.
    interface
        function release_gpu_tf_test_extra_queue_C(C_packet, C_id) result(C_ierr) bind(c)
            use iso_c_binding,     ONLY : C_PTR
            use milhoja_types_mod, ONLY : MILHOJA_INT
            type(C_PTR),          intent(IN), value :: C_packet
            integer(MILHOJA_INT), intent(IN), value :: C_id
            integer(MILHOJA_INT)                    :: C_ierr
        end function release_gpu_tf_test_extra_queue_C
    end interface
