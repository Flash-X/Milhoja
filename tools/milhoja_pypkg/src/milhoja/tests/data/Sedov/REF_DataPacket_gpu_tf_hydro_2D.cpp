...
void DataPacket_gpu_tf_hydro::pack(void) {
    ...
    for (auto n = 0; n < _nTiles_h; n++) {
        ...
        FArray4D scratch_hydro_op1_auxC_device{ static_cast<real*>( static_cast<void*>( static_cast<char*>( static_cast<void*>(_scratch_hydro_op1_auxC_d) ) + n * SIZE_SCRATCH_HYDRO_OP1_AUXC)), (lo)-IntVect{LIST_NDIM(1,1,0)}, ((lo)-IntVect{LIST_NDIM(1,1,0)}) +( IntVect{ LIST_NDIM(18,18,1) } ), 1};
        ...
        FArray4D scratch_hydro_op1_flX_device{ static_cast<real*>( static_cast<void*>( static_cast<char*>( static_cast<void*>(_scratch_hydro_op1_flX_d) ) + n * SIZE_SCRATCH_HYDRO_OP1_FLX)), (lo), ((lo)) +( IntVect{ LIST_NDIM(17,16,1) } ), 5};
        ...
        FArray4D scratch_hydro_op1_flY_device{ static_cast<real*>( static_cast<void*>( static_cast<char*>( static_cast<void*>(_scratch_hydro_op1_flY_d) ) + n * SIZE_SCRATCH_HYDRO_OP1_FLY)), (lo), ((lo)) +( IntVect{ LIST_NDIM(16,17,1) } ), 5};
        ...
        FArray4D scratch_hydro_op1_flZ_device{ static_cast<real*>( static_cast<void*>( static_cast<char*>( static_cast<void*>(_scratch_hydro_op1_flZ_d) ) + n * SIZE_SCRATCH_HYDRO_OP1_FLZ)), IntVect{LIST_NDIM(1,1,1)}, (IntVect{LIST_NDIM(1,1,1)}) +( IntVect{ LIST_NDIM(1,1,1) } ), 1};
