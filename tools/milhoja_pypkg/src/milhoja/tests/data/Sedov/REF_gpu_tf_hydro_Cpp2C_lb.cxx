...
extern "C" {
    ...
    void gpu_tf_hydro_cpp2c (const int threadIndex, void* dataItem_h) {
        ...
        void* _tile_ubound_d = static_cast<void*>( packet_h->_tile_ubound_d );
        void* _tile_arrayBounds_d = static_cast<void*>( packet_h->_tile_arrayBounds_d );
        void* _lbdd_CC_1_d = static_cast<void*>( packet_h->_lbdd_CC_1_d );
        void* _CC_1_d = static_cast<void*>( packet_h->_CC_1_d );
        void* _lbdd_scratch_hydro_op1_auxC_d = static_cast<void*>( packet_h->_lbdd_scratch_hydro_op1_auxC_d );
        ...
        _lbdd_CC_1_d,
        _CC_1_d,
        _lbdd_scratch_hydro_op1_auxC_d,
