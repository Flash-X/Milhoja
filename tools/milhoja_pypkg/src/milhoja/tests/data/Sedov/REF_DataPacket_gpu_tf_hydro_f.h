...
private:
    ...
    static constexpr std::size_t SIZE_U = (8 + 2 * 1 * MILHOJA_K1D) * (8 + 2 * 1 * MILHOJA_K2D) * (8 + 2 * 1 * MILHOJA_K3D) * (9 + 1 - 0) * sizeof(real);
    static constexpr std::size_t SIZE_HYDRO_OP1_AUXC = (10) * (10) * (10) * (1) * sizeof(real);
    static constexpr std::size_t SIZE_HYDRO_OP1_FLX = (11) * (10) * (10) * (5) * sizeof(real);
    static constexpr std::size_t SIZE_HYDRO_OP1_FLY = (10) * (11) * (10) * (5) * sizeof(real);
    static constexpr std::size_t SIZE_HYDRO_OP1_FLZ = (10) * (10) * (11) * (5) * sizeof(real);
