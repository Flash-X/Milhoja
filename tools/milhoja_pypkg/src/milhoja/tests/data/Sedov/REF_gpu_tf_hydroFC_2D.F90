module gpu_tf_hydroFC_mod
    ...
    interface
        ...
        function instantiate_gpu_tf_hydroFC_packet_C( &
                    C_packet, &
                    C_dt &
        ...
        end function instantiate_gpu_tf_hydroFC_packet_C
        ...
        !               data packet
        function delete_gpu_tf_hydroFC_packet_C(C_packet) result(C_ierr) bind(c)
            use iso_c_binding,     ONLY : C_PTR
            use milhoja_types_mod, ONLY : MILHOJA_INT
            type(C_PTR),         intent(IN), value :: C_packet
            integer(MILHOJA_INT)                   :: C_ierr
        end function delete_gpu_tf_hydroFC_packet_C
    end interface
