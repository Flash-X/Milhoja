...
def generate_grid_code(tf_spec_fname, destination, overwrite,
                       indent, makefile_filename, logger):
    """
    Generate all Grid/general test code derived from the given task function
    and a Makefile that indicates which source files need building and where to
    look for headers.

    :param tf_spec_fname: JSON file that specifies task function and
        its data item as needed for test
    ...
    # ----- GENERATE TASK FUNCTION/DATA ITEM PAIR
