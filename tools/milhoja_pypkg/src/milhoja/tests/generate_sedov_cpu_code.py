...
def generate_sedov_cpu_code(tf_specs_all, destination, overwrite,
                            indent, makefile_filename, logger):
    """
    Generate all Sedov test code derived from the given task functions and a
    Makefile that indicates which source files need building and where to look
    for headers.
