...
private:
    ...
    static constexpr std::size_t SIZE_CC_1 = (16 + 2 * 1 * MILHOJA_K1D) * (16 + 2 * 1 * MILHOJA_K2D) * (16 + 2 * 1 * MILHOJA_K3D) * (8 - 0 + 1) * sizeof(real);
    ...
    static constexpr std::size_t SIZE_HYDRO_OP1_FLZ = (16) * (16) * (17) * (5) * sizeof(real);
