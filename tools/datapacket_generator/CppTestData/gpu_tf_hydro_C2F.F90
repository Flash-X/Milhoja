...
C_hydro_op1_flZ_d) bind(c)
	...
	CALL C_F_POINTER(C_U_d, F_U_d, shape=[16 + 2 * 1 * MILHOJA_K1D, 16 + 2 * 1 * MILHOJA_K2D, 16 + 2 * 1 * MILHOJA_K3D, 8 - 0 + 1, F_nTiles_h])
	CALL C_F_POINTER(C_auxC_d, F_auxC_d, shape=[18, 18, 18, F_nTiles_h])
	CALL C_F_POINTER(C_FCX_d, F_FCX_d, shape=[17, 16, 16, 5, F_nTiles_h])
	CALL C_F_POINTER(C_FCY_d, F_FCY_d, shape=[16, 17, 16, 5, F_nTiles_h])
	CALL C_F_POINTER(C_FCZ_d, F_FCZ_d, shape=[16, 16, 17, 5, F_nTiles_h])
