...
TEST(ThreadTeamTest, TestDestruction) {
    RuntimeAction   action_100ms;
    action_100ms.name = "100ms"
    action_100ms.nInitialThreads = 3;
    action_100ms.teamType = ThreadTeamDataType::BLOCK;
    action_100ms.routine = TestThreadRoutines::delay_100ms;
    ...
    team1->startTask(action_100ms, "teamName");
