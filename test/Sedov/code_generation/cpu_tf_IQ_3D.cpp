...
void  cpu_tf_IQ_3D::taskFunction(const int threadId,
                    milhoja::DataItem* dataItem) {
    using namespace milhoja;

    Tile_cpu_tf_IQ_3D*  wrapper = dynamic_cast<Tile_cpu_tf_IQ_3D*>(dataItem);
    ...
    milhoja::Real* ptr_mh_internal_volumes =
        static_cast<milhoja::Real*>(Tile_cpu_tf_IQ_3D::_mh_internal_volumes_)
        + Tile_cpu_tf_IQ_3D::_MH_INTERNAL_VOLUMES_SIZE_ * threadId;
