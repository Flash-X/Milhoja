...
void DataPacket_Hydro_gpu_3::pack(void) {
  ...
  SIZE_DT + SIZE_NTILES
    ...
    if (SIZE_CONSTRUCTOR % ALIGN_SIZE != 0)
        throw std::logic_error("[DataPacket_Hydro_gpu_3] SIZE_CONSTRUCTOR padding failure");
...
//    std::cout << "Constructor size: " << SIZE_CONSTRUCTOR << std::endl;
  ...
  (5 * sizeof(FArray4D)) + SIZE_TILE_DELTAS + SIZE_TILE_LO + SIZE_TILE_HI + 0
    ...
    if (SIZE_TILEMETADATA % ALIGN_SIZE != 0)
        throw std::logic_error("[DataPacket_Hydro_gpu_3] SIZE_TILEMETADATA padding failure");
...
//    std::cout << "Tilemetadata size: " << SIZE_TILEMETADATA << std::endl;
  ...
  0
    ...
    if (SIZE_TILEIN % ALIGN_SIZE != 0)
        throw std::logic_error("[DataPacket_Hydro_gpu_3] SIZE_TILEIN padding failure");
...
//    std::cout << "Tilein size: " << SIZE_TILEIN << std::endl;
  ...
  SIZE_U
    ...
    if (SIZE_TILEINOUT % ALIGN_SIZE != 0)
        throw std::logic_error("[DataPacket_Hydro_gpu_3] SIZE_TILEINOUT padding failure");
...
//    std::cout << "Tileinout size: " << SIZE_TILEINOUT << std::endl;
  ...
  0
    ...
    if (SIZE_TILEOUT % ALIGN_SIZE != 0)
        throw std::logic_error("[DataPacket_Hydro_gpu_3] SIZE_TILEOUT padding failure");

//    std::cout << "Tileout size: " << SIZE_TILEOUT << std::endl;

    std::size_t SIZE_TILESCRATCH = pad( _nTiles_h * (SIZE_AUXC + SIZE_FLX + SIZE_FLY + SIZE_FLZ) );
    if (SIZE_TILESCRATCH % ALIGN_SIZE != 0)
        throw std::logic_error("[DataPacket_Hydro_gpu_3] SIZE_TILESCRATCH padding failure");
