...
//    grid.writePlotfile(rp_Simulation::NAME + "_plt_ICs");
    ...
    hydroAdvance_gpu.routine         = Hydro::advanceSolutionHll_packet_oacc_summit_4;
    ...
    const DataPacket_Hydro_gpu_4    packetPrototype;
...
//###DEV### comment out execute calls for debugging
