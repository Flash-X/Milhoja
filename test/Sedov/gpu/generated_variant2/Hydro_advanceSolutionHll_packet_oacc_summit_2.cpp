...
//    const Real*         dt_d     = static_cast<Real*>((void*)ptr_d);
    ...
    const std::size_t* nTiles_d = static_cast<std::size_t*>( dynamic_cast<DataPacket_Hydro_gpu_2*>(packet_h)->nTiles_getter() );
	const Real* dt_d = static_cast<Real*>( dynamic_cast<DataPacket_Hydro_gpu_2*>(packet_h)->dt_getter() );
