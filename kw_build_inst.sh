...
export KW_INSTALL_DIR=/nfs/gce/projects/FLASH5/kweide/localDbg-milhoja_grid/3dcpu
...
./configure.py --makefile $PWD/sites/gce/Makefile.site.gnu_mpich --dim 3 --offload None --prefix ${KW_INSTALL_DIR} --debug \
	       --support_exec
make clean
