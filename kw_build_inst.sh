...
export KW_INSTALL_DIR=/nfs/gce/projects/FLASH5/kweide/localDbg-milhoja/2dcpu
...
./configure.py --makefile $PWD/sites/gce/Makefile.site.gnu_mpich --dim 2 --offload None --prefix ${KW_INSTALL_DIR} --debug \
	       --support_exec --support_push
make clean
