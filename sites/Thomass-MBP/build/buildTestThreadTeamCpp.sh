...
cp $TESTDIR/constants_base.h $TESTDIR/ThreadTeam/constants.h
sed -i '' "s/N_CELLS_IN_X/$N_CELLS_IN_X/g" $TESTDIR/ThreadTeam/constants.h
...
cp $TESTDIR/Flash_base.h $TESTDIR/ThreadTeam/Flash.h
sed -i '' "s/N_BLOCKS_ALONG_X/$N_BLOCKS_X/g" $TESTDIR/ThreadTeam/Flash.h
