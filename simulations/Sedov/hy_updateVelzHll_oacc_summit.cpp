...
void hy::updateVelzHll_oacc_summit(const orchestration::IntVect& lo,
...
#if NDIM == 1
                Uout(i, j, k, VELZ_VAR_C) = (  Uin(i, j, k, VELZ_VAR_C) * Uin(i, j, k, DENS_VAR_C)
                                             + flX(i,   j, k, HY_ZMOM_FLUX_C)
                                             - flX(i+1, j, k, HY_ZMOM_FLUX_C) ) * invNewDens;
#elif NDIM == 2
                Uout(i, j, k, VELZ_VAR_C) = (  Uin(i, j, k, VELZ_VAR_C) * Uin(i, j, k, DENS_VAR_C)
                                             + flX(i,   j,   k, HY_ZMOM_FLUX_C)
                                             - flX(i+1, j,   k, HY_ZMOM_FLUX_C)
                                             + flY(i,   j,   k, HY_ZMOM_FLUX_C)
                                             - flY(i,   j+1, k, HY_ZMOM_FLUX_C) ) * invNewDens;
#elif NDIM == 3
                Uout(i, j, k, VELZ_VAR_C) = (  Uin(i, j, k, VELZ_VAR_C) * Uin(i, j, k, DENS_VAR_C)
                                             + flX(i,   j,   k,   HY_ZMOM_FLUX_C)
                                             - flX(i+1, j,   k,   HY_ZMOM_FLUX_C)
                                             ...
                                             - flZ(i,   j,   k+1, HY_ZMOM_FLUX_C) ) * invNewDens;
#endif
            }
        }
    }
